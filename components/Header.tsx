  ...
  return (
    <div className="sticky top-0 z-50 flex bg-white px-4 py-2 shadow-sm items-center">
      <div className="relative h-14 w-20 flex-shrink-0 cursor-pointer">
        <Link href="/">
        <Image objectFit="contain" src="/thockit.jpg" layout="fill" priority/>
        </Link>
      </div>
      ...
      {session ? (
        ...
        >
          <div className="relative h-6 w-6 flex-shrink-0">
            <Image objectFit="contain" src="/cow.jpg" layout="fill" priority/>
          </div>
        ...
        >
          <div className="relative h-6 w-6 flex-shrink-0">
            <Image objectFit="contain" src="/cow.jpg" layout="fill" />
          </div>
